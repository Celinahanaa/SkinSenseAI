  ...
  return (
    <footer className="bg-gray-900 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Bottom bar */}
        <div className="border-t-2 border-white mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-white-500 text-xs">© 2026 SkinSense AI. All rights reserved.</p>
